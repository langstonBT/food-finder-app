...
import greekDinner from "../Images/greek-dinner-in-restaurant.jpg"
    ...
    return (
        <div className="index-page">
            ...
            <div className="title-page-photo-with-text">
                <img class="table-photo" src={tableMeal}/>
                  
            </div>

            
            <div className="third-page-space">
                    <img className="third-image-index-page" src={pinkDessert} />
            ...
            <div className="fourth-page-source">
                <div className="individual-card"> 
                    <img className="fourth-section-image" src={cookies} 
                    id="section1"/>
                ...
                <div className="individual-card"> 
                    <img className="fourth-section-image" src={salad} 
                    id="section2"/>
                    <h1 className= "fourth-section-title"
